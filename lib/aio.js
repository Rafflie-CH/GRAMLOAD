...
async function aio(url) {
    try {
        ...
        if (!SUPPORTED_PLATFORMS.some((regex) => regex.test(url))) throw new Error('Platform not supported');
        ...
        const { data } = await axios.post('https://allinonedownloader.com/system/f7c4d28c5e53c49.php', form, {
            headers: {
                accept: '*/*',
